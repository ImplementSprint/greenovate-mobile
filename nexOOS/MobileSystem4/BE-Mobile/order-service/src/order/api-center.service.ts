...
type TribeClientType = {
  authenticate: () => Promise<void>;
  paymentCreateCheckoutSession: (payload: unknown) => Promise<unknown>;
  paymentGetCheckoutStatus: (checkoutId: string) => Promise<unknown>;
  emailSend: (payload: EmailSendRequest) => Promise<void>;
  kafkaPublish: (payload: {
    topic: string;
    eventType: string;
