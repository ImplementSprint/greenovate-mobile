...
const defaultAppName = 'Shelf Awareness';
...
export default function getExpoConfig(): ExpoConfig {
  ...
  return withCiKotlinGradleProperty({
    name: appName,
    slug: 'shelf-awareness',
    version: '1.0.0',
    orientation: 'portrait',
    scheme: 'shelfawareness',
    ...
    android: {
      package: 'com.greenovate.shelfawareness',
    },
    ios: {
      bundleIdentifier: 'com.greenovate.shelfawareness',
      infoPlist: {
